...
$query = "SELECT * FROM catastro WHERE catastro = '$search'";
...
if ($fila = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) {
  ...
  <?php
        ...
        ?>
         <h1 align="center"><?php echo "No. de Catastro no aparece en el Registro de Catastro" ?></h1>
